	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:400px">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="checkbox" class="form-check" id="name" name="payslip" value="1" <?php echo $payslip;?>>  Payslip
          </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name"></label>
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="name"></label>
          <div class="col-lg-9">
            <input type="checkbox" class="form-check" id="name" name="cert" value="1" <?php echo $cert;?>> Brgy. Certificate 
          </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name"></label>
          <div class="col-lg-9">
            <input type="checkbox" class="form-check" id="name" name="cedula" value="1" <?php echo $cedula;?>>  Cedula
          </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name"></label>
          <div class="col-lg-9">
            <input type="checkbox" class="form-check" id="name" name="income" value="1" <?php echo $income;?>>  Proof of Income
          </div>
        </div>        
