...
include('../dist/includes/dbcon.php');
	...
	$saletype = $_POST['saletype'];
		...
		mysqli_query($con,"INSERT INTO sales(cust_id,user_id,amount_due,total,date_added,branch_id,modeofpayment,saletype) 
	VALUES('$cid','$id','$amount_due','$total','$date','$branch','credit','$saletype')")or die(mysqli_error($con));
