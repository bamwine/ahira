              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  $cid=$_REQUEST['cid'];
								...
								?>		<optgroup label="<?php echo $row['serial'];?>">
...
<?php }?>					  
          ...
          <form method="post" name="autoSumForm" action="sales_add.php">
				  <div class="row">
					 <div class="col-md-12">
						...
						<!--  <div class="form-group">
							...
							<input type="text" style="text-align:right" class="form-control" id="total" name="name"  tabindex="5" >
							
						  </div> /.form group -->
						  
						   <div class="form-group">
							<label for="saletype">Sales Types</label>
						  ...
						  <div class="form-group">
							<label for="date">Total</label>
								...
								<input type="number" style="text-align:right" class="form-control" id="total" name="total" placeholder="Total" 
              ...
              <div class="form-group" id="tendered">
                ...
                <input type="number" style="text-align:right" class="form-control" onFocus="startCalc();" onBlur="stopCalc();"  id="cash" name="tendered" placeholder="Cash Tendered" value="0">
              </div><!-- /.form group -->
              <div class="form-group" id="change">
                <label for="date">Change</label><br>
                <input type="number" style="text-align:right" class="form-control" id="changed" name="change" placeholder="Change">
              </div><!-- /.form group -->
					</div>
