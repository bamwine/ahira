			 ...
			 include('../dist/includes/dbcon.php');
		      ...
		      <?php }?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="qty" placeholder="Amount" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="product_update.php" enctype='multipart/form-data'>
				...
				<div class="form-group">
					<label class="control-label col-lg-3" for="file">Unit</label>
					<div class="col-lg-9">
					    <select class="form-control select2" style="width: 100%;" name="prod_unit" required>
